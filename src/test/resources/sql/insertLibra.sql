...
INSERT INTO `libra`.`Utente` (`email`, `password`, `indirizzo`, `telefono`, `imgProfilo`, `ruolo`, `dataDiNascita`) VALUES ('stefano@unisa.it', '321321', 'Via del Segretario', '0325568798', 'img2', 'Segreteria', '16-05-1995');
