...
public class CaricaPpfServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (ruolo.contains("Azienda")) {
      ...
      /*
       * File file = new File(
       * "C:/Users/Umberto/Desktop/wildfly-11.0.0.Final/wildfly-11.0.0.Final/ProposteFormative/" +
       * nomeFile);
       */

      /* copio il contenuto del file caricato in un nuovo file */
      /*
       * InputStream filestream = filePart.getInputStream(); Files.copy(filestream, file.toPath(),
