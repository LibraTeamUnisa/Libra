		...
		<div class="user-profile">
			...
			<div class="profile-img">
				<img class="imgProfiloUtenteCorrente" src=""
					onerror="this.src='assets/images/users/default.png';" alt="" />
			</div>
			...
			<ul id="sidebarnav">
				...
				<li><a href="<%=JspPagesIndex.PF_INVIATI.substring(1)%>"
					aria-expanded="false"><span class="hide-menu">Progetti
							Formativi</span></a></li>
				<li><a href="<%=JspPagesIndex.VALUTA_STUDENTI.substring(1)%>"
					aria-expanded="false"><span class="hide-menu">Valuta
							Studenti</span></a></li>
				...
				<li><a
					...
					aria-expanded="false"><span class="hide-menu">Contatti</span></a></li>
