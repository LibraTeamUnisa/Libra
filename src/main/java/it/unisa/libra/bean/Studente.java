...
@NamedQueries({ @NamedQuery(name = "Studente.findAll", query = "SELECT s FROM Studente s"),
		@NamedQuery(name = "Studente.findAllSurnameOrdered", query = "SELECT s FROM Studente s ORDER BY s.cognome ASC"),
...
public class Studente implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "preferenza", joinColumns = { @JoinColumn(name = "studenteEmail") }, inverseJoinColumns = {
