...
INSERT INTO `libra`.`Utente` (`email`, `password`, `indirizzo`, `telefono`, `imgProfilo`, `ruolo`) VALUES ('andrea@studenti.unisa.it', '312312', 'Via dello studente', '065987855', 'img3', 'Studente');
