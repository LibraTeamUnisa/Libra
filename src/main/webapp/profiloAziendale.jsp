<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%
		...
		for(ProgettoFormativo pf: listaProposte) {
			String mail = pf.getAzienda().getUtenteEmail();
			if(mail != null) {
				if(mail.contains(azienda.getUtenteEmail()))
				{
				...
				<div class="card wizard-card" style="padding: 1%">
							...
							<table class="table table-responsive">
	                    		...
	                    		for(ProgettoFormativo pf1: listaProposteStudente) {
	                    			List<Feedback> feedbackRicevuti= feedbackDAO.findByType(pf1.getId(), "Studente");
									...
									<tr>
										<td>
											...
											%>
													...
													<p>Valutazione da:<%= pf.getStudente().getNome() %></p> 
