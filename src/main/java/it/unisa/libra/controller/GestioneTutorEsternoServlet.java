...
/**
 * Servlet implementation class GestioneTutorEsternoServlet. Controller class
 * che gestisce le operazioni di aggiunta, modifica e rimozione di un tutor
 * esterno associato ad un'azienda.
 * 
...
public class GestioneTutorEsternoServlet extends HttpServlet {
	 ...
	 * 
	 * @param azienda
	 *            l'azienda a cui aggiungere il tutor
	 * @param tutor
	 *            il tutor da aggiungere all'azienda
	 */
