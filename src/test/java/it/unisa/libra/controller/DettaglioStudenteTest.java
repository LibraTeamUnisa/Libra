...
public class DettaglioStudenteTest {
  ...
  /*
   * @Test public void dettaglioStudenteTest() throws Exception { String ruolo = "Presidente";
   ...
   * 
   * verify(request).setAttribute("studente", studente); verify(dispatcher).forward(request,
   * response); }
   * 
   * @Test public void failRuoloDettaglioStudenteTest() throws Exception { String ruolo =
   * "Studente"; String mail = "mail@mail.it";
   * 
   * when(request.getSession()).thenReturn(session);
   * when(session.getAttribute("utenteRuolo")).thenReturn(ruolo);
   * when(request.getParameter(Actions.ACTION)).thenReturn("dettaglioStudente");
   ...
   * }
   * 
   * @Test public void failActionDettaglioStudenteTest() throws Exception { String ruolo =
   * "Studente";
   * 
   * when(request.getSession()).thenReturn(session);
   * when(session.getAttribute("utenteRuolo")).thenReturn(ruolo);
   ...
   * }
   * 
   * @Test public void failParametroMancanteDettaglioStudenteTest() throws Exception { String ruolo
   * = "Studente";
   * 
   * when(request.getSession()).thenReturn(session);
   * when(session.getAttribute("utenteRuolo")).thenReturn(ruolo);
