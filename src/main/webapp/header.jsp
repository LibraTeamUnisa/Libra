...
<header class="topbar">
	<nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="dashboard<%=ruoloHEADER%>.jsp"> <!-- Logo icon -->
				<b> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
					...
					src="assets/images/logo-icon.png" alt="homepage" class="light-logo" />
					...
					src="assets/images/logo-text.png" class="light-logo" alt="homepage" /></span>
			</a>
		</div>
		<!-- ============================================================== -->
		<!-- End Logo -->
			...
			<ul class="navbar-nav my-lg-0">
				...
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false"> <img
						class="profile-pic imgProfiloUtenteCorrente" src=""
						onerror="this.src='assets/images/users/default.png';" alt="user" />
				</a>
							...
							<li>
								<div class="dw-user-box row">
									...
									<div class="u-img col-4">
										<img class="imgProfiloUtenteCorrente" src=""
									...
									<div class="u-text col-8">
										...
										<a href="dashboard<%=ruoloHEADER%>.jsp"
											class="btn btn-rounded btn-danger btn-sm">Dashboard</a>
									</div>
								</div>
							</li>
