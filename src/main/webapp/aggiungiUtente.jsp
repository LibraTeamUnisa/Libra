				...
				<section id="wrapper">
					...
					<center>
						<div>
							<select id="ruolo" name="ruolo" onchange="cambiaForm()">
								...
								<option value="TutorInterno" name="TutorInterno">Tutor
									Interno</option>
					...
					<div id="formPresidente" style="display: block;">
						<form action="GestioneUtServlet" method="post"
							...
							<div class="row">
								<div class="col">
									Email Istituzionale:<input placeholder="" class="form-control"
										id="email" name="email" type="email" required>
								</div>
								<div class="col">
									Nome:<input placeholder="" type="text" class="form-control"
										id="nome" name="nome" pattern="[A-Za-z]{1,20}" value=""
										required>
								</div>
							</div>
							<br>
							...
							<div class="row">
								<div class="col">
									Cognome:<input placeholder="" type="text" class="form-control"
										id="cognome" name="cognome" pattern="[A-Za-z]{1,20}" value=""
										required>
								</div>
								<div class="col">
									Telefono:<input placeholder="" type="text" class="form-control"
										id="telefono" name="telefono" value="" pattern="[0-9]{8-15}"
										required>
								</div>
							</div>
							<br>
							...
							<div class="row">
								<div class="col">
									Indirizzo:<input placeholder="" type="text"
										class="form-control" id="indirizzo" name="indirizzo" value=""
										required>
								</div>
								<div class="col">
									Ufficio: <input placeholder="" type="text" class="form-control"
										id="ufficio" name="ufficio" value="" required>
								</div>
							</div>
							<br>
							<br>
							<div class="row">
								<div class="col">
									Giorni di ricevimento:<input placeholder="" type="text"
										class="form-control" id="giornoDiRicevimento"
										name="giornoDiRicevimento" value="" required>
								</div>
								<div class="col">
									WebSite:<input placeholder="" type="text" class="form-control"
										id="webSite" name="webSite" value="" required>
								</div>
							</div>
							<br>
							<br>
							<div class="row">
								<div class="col">
									Data Di Nascita:<input placeholder="" type="date"
										class="form-control" id="bday" name="bday" value="" required>
								</div>
							</div>
							<br>
							<br>
							<div class="row">
								<div class="col">
									Password:<input placeholder="" type="password"
										class="form-control" id="password" name="password" required>
								</div>
								<div class="col">
									Conferma Password:<input placeholder="" type="password"
					...
					<div id="formAzienda" class="form-horizontal form-material"
						...
						<form action="GestioneUtServlet" method="post"
							...
							<div class="row">
								<div class="col">
									Partita IVA:<input placeholder="" type="text"
										class="form-control" id="partitaIva2" name="partitaIva"
										value="" pattern="[0-9]{11}" required>
								</div>
								<div class="col">
									Telefono:<input placeholder="" type="text" class="form-control"
										id="telefono" name="telefono" value="" required>
								</div>
							</div>
							<br>
							<br>
