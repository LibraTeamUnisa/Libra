...
public class GestioneFeedbackAziendaServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  for(Domanda d: domande) {
		  String radioInput= request.getParameter(String.valueOf(d.getId()));
		  persistFeedback(radioInput, d.getId(), idProgettoFormativo);
	  }
	  
	  String textAreaInput = request.getParameter("note");
	  response.getWriter().write("feedback_persisted");
