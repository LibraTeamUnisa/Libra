...
public class ModificaTutorEsternoTest extends GestioneTutorEsternoServlet {
  ...
  public void allParameters() {
    try {
      ...
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), NEW_NAME, NEW_SURNAME,
          NEW_DATE, NEW_TELEPHONE, NEW_ADDRESS, NEW_SCOPE);

      super.doPost(request, response);
      verify(response).setStatus(HttpServletResponse.SC_OK);
      TutorEsterno result =
          em.find(TutorEsterno.class, getKey(azienda.getUtenteEmail(), NEW_SCOPE));
  ...
  public void zeroParameters() {
    try {
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), null, null, null, null,
          null, null);
      super.doPost(request, response);
  ...
  public void oneParameter() {
    try {
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), NEW_NAME, null, null,
          null, null, null);
      super.doPost(request, response);
      verify(response).setStatus(HttpServletResponse.SC_OK);
      TutorEsterno result = em.find(TutorEsterno.class, key);
  ...
  public void twoParameter() {
    try {
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), null, null, null,
          NEW_TELEPHONE, NEW_ADDRESS, null);
      super.doPost(request, response);
      verify(response).setStatus(HttpServletResponse.SC_OK);
      TutorEsterno result = em.find(TutorEsterno.class, key);
      assertEquals(tutor.getNome(), result.getNome());
  ...
  public void threeParameter() {
    try {
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), null, null, null,
          NEW_TELEPHONE, NEW_ADDRESS, NEW_SCOPE);
      super.doPost(request, response);
      verify(response).setStatus(HttpServletResponse.SC_OK);
      TutorEsterno result =
          em.find(TutorEsterno.class, getKey(azienda.getUtenteEmail(), NEW_SCOPE));
  ...
  public void fourParameter() {
    try {
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), null, null, NEW_DATE,
          NEW_TELEPHONE, NEW_ADDRESS, NEW_SCOPE);
      super.doPost(request, response);
      verify(response).setStatus(HttpServletResponse.SC_OK);
      TutorEsterno result =
  ...
  public void fiveParameter() {
    try {
      initTest(tutor.getId().getAmbito(), tutor.getId().getAziendaEmail(), null, NEW_SURNAME,
          NEW_DATE, NEW_TELEPHONE, NEW_ADDRESS, NEW_SCOPE);
      super.doPost(request, response);
      verify(response).setStatus(HttpServletResponse.SC_OK);
      TutorEsterno result =
  ...
  private void initTest(String idTutor, String idAzienda, String nome, String cognome, String data,
      String telefono, String indirizzo, String ambito) throws Exception {
