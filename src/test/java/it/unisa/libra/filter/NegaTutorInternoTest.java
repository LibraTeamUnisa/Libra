...
public class NegaTutorInternoTest {

  NegaTutorInterno filter = new NegaTutorInterno();
  ...
  public void paginaConcessaTest() throws Exception {
    when(request.getSession().getAttribute("utenteRuolo")).thenReturn("NotTutorInternoRuolo");
    filter.doFilter(request, response, chain);
