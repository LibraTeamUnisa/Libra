<aside class="left-sidebar">
                ...
                <div class="user-profile">
                    ...
                    <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Markarn Doe <span class="caret"></span></a>
                        <div class="dropdown-menu animated flipInY">
                            ...
                            <div class="dropdown-divider"></div> <a href="${pageContext.request.contextPath}/autenticazione?action=logout" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="sidebar-footer">
                ...
                <!-- item-->
                <a href="${pageContext.request.contextPath}/autenticazione?action=logout" class="link" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
            </div>
            <!-- End Bottom points-->
        </aside>