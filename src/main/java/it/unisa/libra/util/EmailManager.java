...
/**
 * Definisce un manager di email che si occupa delle impostazioni delle proprietà e dell'invio 
 * di un messaggio di posta elettronica ad un server SMTP che provvede ad effettuare il
 * delivery ad un destinatario opportunamente specificato.
 * @author Mauro Vitale
 * @version 1.0
 */
public class EmailManager 
{
  ...
  /**
   * Consente di specificare una nuova password per l'autenticazione presso il server SMTP specificato
  ...
  /**
   * Effettua la creazione dell'oggetto necessario per l'autenticazione presso un server
   * SMTP che la richiede.
   ...
   */
  public MimeMessage setUpMessage(Properties props,Authenticator auth,String to,String subject,String body) 
